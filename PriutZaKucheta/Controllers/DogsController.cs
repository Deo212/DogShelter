...
namespace DogShelter.Controllers
{
    public class DogsController : Controller
    {
        ...
        {
            var applicationDbContext = _context.Dogs.Include(d => d.Place).Include(d => d.RequestDog);
        ...
        public async Task<IActionResult> Create([Bind("Id,Name,Age,Breed,Description,Picture,IsAdopted,RequestDogId,PlaceId")] Dog dog)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Name,Age,Breed,Description,Picture,IsAdopted,RequestDogId,PlaceId")] Dog dog)
        {
            if (id != dog.Id)
            {
                return NotFound();
